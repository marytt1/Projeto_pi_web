...
| :--- | :--- | :--- | :--- |
| **RF01** | Gestão de Catálogo | Admin | Permitir o cadastro, edição e exclusão de roupas. |
| **RF02** | Controle de Variações | Admin | Cadastrar variações de um mesmo produto (ex: Top Fitness nas cores Preto/Rosa e tamanhos P, M, G). |
| **RF03** | Gestão de Estoque | Admin | Atualizar e visualizar a quantidade física de cada variação de roupa. |
